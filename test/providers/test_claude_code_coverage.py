...
class TestHandleStartupPromptsBranches:
    ...
    @pytest.mark.asyncio
    @patch("cli_agent_orchestrator.backends.registry._backend")
    async def test_echoed_prompt_does_not_short_circuit_trust(self, mock_backend, provider):
        ...
        mock_backend.get_history.side_effect = [echoed_launch_cmd, trust_frame, trust_frame]
